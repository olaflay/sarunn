    ...
    <RunnaShell>
      <div className="sarunn-screen bg-background">
        <div className="flex items-center gap-3 px-4 py-4 bg-white border-b border-border/40 sticky top-0 z-30">
          ...
          <h1 className="font-heading font-bold text-foreground text-base">About SARUNN</h1>
        </div>
        ...
        <div className="px-5 py-6 space-y-5">
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              <p className="font-heading font-extrabold text-xl" style={{ color: '#1B2B45' }}>SARUNN</p>
          ...
          <div className="prose prose-sm max-w-none">
            <p className="text-sm text-foreground leading-relaxed">
              SARUNN is a campus-first delivery super-app built specifically for Nigerian university communities.
            ...
            <p className="text-sm text-foreground leading-relaxed mt-3">
              SARUNN operates on a three-level location system — Campus, Zone, and Landmark — ensuring every
            ...
            <p className="text-sm text-foreground leading-relaxed mt-3">
              Built by a team passionate about solving last-mile logistics for African universities, SARUNN
              leverages modern mobile technology to make campus life easier, faster, and more connected.
              Whether it's a plate of jollof rice between lectures or sending a parcel across campus, SARUNN
